...
<div class="row my-1 align-center "   >
        <div class="card-group border-0  justify-content-center" style="  border: 1px solid #000000; max-width: 158vh; margin-left: 5rem; " >
            <?php    
                        $count = -1;
                        foreach ($allPdkharga as $prdk) : 
                            
                            if (++$count == 48) break;
                        ?>
          <div class="col">
          <div class="card " style="width: 13rem; margin: 0.3rem; border-radius: 5px; ">              
                <img src="<?php echo base_url()."/assets/produk/".$prdk->image ?>" class="my-2" style="border: 0.5px solid #A9A9A9; border-radius: 10px; max-width: 20vh; height: 16vh; display:block; margin-left: auto; margin-right: auto;" class="card-img-top" alt="...">
                <div class="card border-0 my-1" style="height: 12vh; margin-left: 18px; ">
                    <h1 class="bold900" style="font-size: 10pt; color: #000000;"><?php echo $prdk->nama_produk ?></h1>
                    <div class="row " style="display: flex;align-items: center;  margin: 2px; margin-left: 0px;">
                        ...
                        <span style="font-size: 10pt;">4.5 (<?php echo $prdk->stok ?> Items)</span>
                        <h1  style="color: #e74a3b; font-size: 14pt;">Rp  <?php echo $prdk->harga ?></h1>
                      </div>
                    </div>
