...
<div class="row my-1 align-center "   >
        <div class="card-group border-0  justify-content-center" style="  border: 1px solid #000000; max-width: 155vh; margin-left: 5rem; " >
            <?php    
                        $count = -1;
          ...
          <div class="col">
            <div class="card " style="width: 13rem; margin: 0.3rem; border-radius: 5px; ">              
                ...
                <div class="card border-0 my-1" style="height: 12vh; margin-left: 18px; ">
                  ...
                  <a class="btn btn-primary" href="<?= base_url('dashboard/detailProduk/' . $prdk->id_produk); ?>">BUY</a>
            </div>  
          </div>
